...
return [
    ...
    'pneumatic_cylinders_text' => 'Sachio Pneumatic Cylinders provide fast and precise linear motion using compressed air and built with durable materials.',

    'lorem_ipsum' => 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolor',

    'air_source_title' => 'Air Source Treatment Unit',
    'air_source_text' => 'Sachio Air Source Treatment Units ensure clean, dry, and regulated air supply for pneumatic systems. Designed with precision filters, regulators, and lubricators, they help improve performance, extend equipment life, and maintain stable operations in various industrial applications.',


    'directional_valve_title' => 'Directional Valve',
    'directional_valve_text' => 'Sachio Directional Valves control the flow direction of compressed air within pneumatic systems, ensuring accurate and efficient operation. Built for reliability and long service life, they are essential components in automation, manufacturing, and industrial machinery',


    'fluid_solenoid_valve_title' => 'Fluid Solenoid Valve',
    'fluid_solenoid_valve_text' => 'Sachio Fluid Solenoid Valves provide precise and reliable control of fluid and air flow using advanced electromagnetic actuation. Compact and durable, they are widely applied in automation, process control, and industrial machinery to ensure safe and efficient operations.',

    'pneumatic_accessories_title' => 'Pneumatic Accessories',
    'pneumatic_accessories_text' => 'Pneumatic Accessories support and enhance the performance of pneumatic systems, from connectors and fittings to silencers and tubing. Designed with precision and durability, they ensure smooth installation, reliable connections, and long-term efficiency across various industrial applications.',
