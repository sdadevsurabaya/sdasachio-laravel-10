                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gx-3 row-gap-3 gx-xl-4">
                            ...
                            <a href="sda-cikarang-opening.php" class="text-decoration-none">
                                <div class="card h-100 rounded-0 border-0">
                                    <div class="card-header border-0 ratio ratio-1x1">
                                        <img src="../assets/img/gambar/image-home-pneumatics.png"
                        ...
                        <div class="col">
                            <a href="sda-cikarang-opening.php" class="text-decoration-none">
                                <div class="card h-100 rounded-0 border-0">
                                    <div class="card-header border-0 ratio ratio-1x1">
                                        <img src="../assets/img/gambar/image-home-airsource.png"
                                            class="object-fit-cover" alt="">
                                    </div>
                                    <div class="card-body ps-0">
                                        <div class="title">
                        ...
                        <div class="col">
                            <a href="sda-cikarang-opening.php" class="text-decoration-none">
                                <div class="card h-100 rounded-0 border-0">
                                    <div class="card-header border-0 ratio ratio-1x1">
                                        <img src="../assets/img/gambar/image-home-directionalvalves.png"
                                            class="object-fit-cover" alt="">
                                    </div>
                                    <div class="card-body ps-0">
                                        <div class="title">
                            ...
                            <div
                                ...
                                <div class="col col-12 col-lg-7">
                                    <div class="ratio ratio-2x1 bg-secondary">
                                        <img src="../assets/img/gambar/banner-2.jpg" class="object-fit-cover"
                                            alt="">
                                    </div>
                                </div><!-- end col -->
