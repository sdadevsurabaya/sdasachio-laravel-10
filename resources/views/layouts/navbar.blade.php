...
<div id="produk-menu" class="collapse position-absolute w-100 bg-white shadow-sm" style="top: 80px; z-index: 1000;">
   <div class="container">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="width: 300px; height: 100%; overflow-y:scroll">
