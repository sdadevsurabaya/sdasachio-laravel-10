                    ...
                    <div class="container">
                        ...
                        <div class="row gx-lg-5 row-gap-5 justify-content-lg-between">
                            ...
                            <div class="col col-lg-6 pe-0 pe-lg-5">
                                <form action="contact_process.php" method="POST" class="d-flex flex-column row-gap-4" style="max-width: calc(36rem + 2vw);">

                                    <div class="form-group">
                                        <input type="text" class="form-control fs-6 form-control-lg rounded-0 border-secondary opacity-50 fw-light" placeholder="Name" name="name">
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control fs-6 form-control-lg rounded-0 border-secondary opacity-50 fw-light" placeholder="Email Address" name="email">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control fs-6 form-control-lg rounded-0 border-secondary opacity-50 fw-light" placeholder="Alamat" name="Alamat">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control fs-6 form-control-lg rounded-0 border-secondary opacity-50 fw-light" placeholder="Contact Number" name="contact_number">
                                    </div>
                                    <div class="form-group">
                                        <textarea name="message" rows="10" id="" class="form-control fs-6 rounded-0 border-secondary opacity-50 fw-light"></textarea>
                                    </div>
                    ...
                    <div class="container">
                        <div class="d-flex flex-column flex-md-row vh-100" style="max-height:400px;">
                            ...
                            <div class="col-md-7 p-0">
                                <img src="https://storage.googleapis.com/a1aa/image/bcf9c4f0-c1cd-414f-bdd9-2de0a0db0ed8.jpg" alt="Map with red and gray location pins on a light gray street map background" class="img-fluid h-100 w-100 object-fit-cover" style="max-height:400px;" />
                            </div>
                        </div>
                    </div>
                </section>
